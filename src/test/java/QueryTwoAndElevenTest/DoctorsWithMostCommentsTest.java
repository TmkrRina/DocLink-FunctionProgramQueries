...
cal3.set(2020,3,16);
       ...
       @Test
    public void test(){
       // System.out.println(DoctorsWithMostComments.getDoctor.apply(comments,cal.getTime(),cal2.getTime()));
        assertEquals(user2, DoctorsWithMostComments.getDoctor.apply(comments,cal.getTime(),cal2.getTime()));
       }
       public void test2(){
