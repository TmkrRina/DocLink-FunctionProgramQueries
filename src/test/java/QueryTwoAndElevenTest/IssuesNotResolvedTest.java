...
public class IssuesNotResolvedTest {
        ...
        User user = new User(1,"User1", "Last1",new Date(), "USA", "email@gmail.com");
        List<Post> posts;
        List<Category> categories = new ArrayList<Category>(){ { add(Category.HEART); add(Category.CHEST); } };
    HealthIssue post;
    HealthIssue post1;
    HealthIssue post2;
    HealthIssue post3;
    ...
    public void notResolved(){
        ...
        Assert.assertEquals(expectedResult,functionResult);
    }
