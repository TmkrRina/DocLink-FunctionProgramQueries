...
public class PerryQ {
    ...
    public void categories() {
        hashMap2.put(Category.SKIN, new ArrayList());
        hashMap2.put(Category.EAR_NOSE_THROAT, new ArrayList());
        hashMap2.put(Category.EYES, new ArrayList());
        hashMap2.put(Category.DENTAL, testPosts);
        hashMap2.put(Category.HEART, testPosts);
        hashMap2.put(Category.CHEST, testPosts);

        assertEquals(hashMap2, FunctionForQ.categories.apply(testPosts));
